              ...
              {activeTab === 0 && (
                <div className='tab-box'>
                  <div style={{display: 'flex'}}>
                    <div style={{ display: 'flex', alignItems: 'center', marginBottom: '10px', width: '30%'}}>
                      <div style={{ fontSize: '20px', marginRight: '20px', fontWeight: 'bold' }}>Current Area: {currArea}</div>
                    </div>
                    <div style={{ display: 'flex', alignItems: 'right', justifyContent: 'flex-end', marginBottom: '10px', width: '68.5%'}}>
                        <button 
